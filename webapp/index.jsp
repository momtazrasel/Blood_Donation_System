<%-- 
    Document   : index
    Created on : Jul 18, 2019, 1:47:14 AM
    Author     : User
--%>
...
<html lang="en-US">
    ...
    <body>
        ...
        <div class="imgeber">
            <figure>
                <div class="slide"><img src="Image/img1.jpg" alt="" /></div>

                <div class="slide"><img src="Image/img2.png" alt="" /></div>

                <div class="slide"><img src="Image/img3.png" alt="" /></div>

                <div class="slide"><img src="Image/img4.jpg" alt="" /></div>
            </figure>
        </div>
                    ...
                    <table border="3">
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql05 = "SELECT first_name,surname,blood_group,email,phone,calendar,address from createaccount";
        ...
        <div class="button1">
            <div class="container">
                <a href="donor_list.jsp"><input type="button" value="See More" /> </a>
            </div>
        </div>
