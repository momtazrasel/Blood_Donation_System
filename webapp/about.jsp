<%-- 
    Document   : about
    Created on : Jul 27, 2019, 9:34:38 PM
    Author     : User
--%>
...
<body>
	...
	<div class="singup">
		...
		<div class="signuppart">
			...
			<h1 class="createtext">Donate Blood</h1>
                        
               <div class="about ">
			  <h2>Why should you donate blood?</h2>
			  <img src="Image/blood.jpg"  alt= "show image"/>
			  <p>
...
Blood is the most precious gift that anyone can give to another person — the gift of life. A decision to donate your blood can save a life, or even several if your blood is separated into its components — red cells, platelets and plasma — which can be used individually for patients with specific conditions.
			  ...
			  <div class="relatedpost ">
				 ...
				 <a href="https://en.wikipedia.org/wiki/Dengue_fever"> <img src="Image/dengue.jpg" alt="post Image"/></a>
				 <a href="#"> <img src="Image/b_group.jpg" alt="post Image"/></a>
				 <a href="#"> <img src="Image/lod.jpg" alt="post Image"/></a>
				 <a href="#"> <img src="Image/lod.jpg" alt="post Image"/></a>
				 <a href="#"> <img src="Image/lod.jpg" alt="post Image"/></a>
