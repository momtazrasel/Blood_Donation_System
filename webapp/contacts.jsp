<%-- 
    Document   : contacts
    Created on : Jul 27, 2019, 9:35:41 PM
    Author     : User
--%>
...
<body>
	...
	<div class="login">
		...
		<div class="loginpart">
			...
			<h1 class="createtext"> About Us</h1>
                        
               <div class="maincontent1 ">
               <div class="about1 ">
			  <h2>Avijit Datta</h2>
			  <img src="Image/avi.jpg" alt="show image"/>
                          <p>I am Avijit Datta.I am from Debidwar,Cumilla.<br>
                              Email: datta.avijit97@gmail.com <br>
                          Pnone: 01859784694
			  </p>
			  </div>
              ...
              <div class="about1 ">
			  <h2>Momtaz Rashel</h2>
			  <img src="Image/mom.jpg" alt="show image"/>
			  <p>I am Momtaz Uddin Rashel.I am from mirsharai,chittagong.
			  Email: momtazrasel8@gmail.com <br>
                          Pnone: 01834257075
			  </p>
			  </div>
			  </div>
                 ...
                 <div class="about1">
			  <h2>Md. Kamrul Islam</h2>
			  <img src="Image/kamrul.jpg" alt="show image"/>
			  <p>I am Md. Kamrul Islam.I am from Parbatipur,Dinajpur.
			  Email: kamrulewucse@gmail.com <br>
                          Pnone: 01521560159
			  </p>
			  </div>
                 </div>
