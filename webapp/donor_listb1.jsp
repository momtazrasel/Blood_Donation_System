<%-- 
    Document   : donor_listb1
    Created on : Jul 23, 2019, 12:47:26 AM
    Author     : User
--%>
                    ...
                    <table border="1" >
                        ...
                        <%
                            ...
                            try {
                                ...
                                String sql05 = "SELECT first_name,surname,blood_group,email,phone,calendar from createaccount where blood_group='B+'";
