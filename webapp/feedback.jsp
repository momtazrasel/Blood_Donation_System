<%-- 
    Document   : feedback
    Created on : Aug 2, 2019, 11:26:38 PM
    Author     : User
--%>
...
<body>
	...
	<div class="login">
		...
		<div class="loginpart">
			...
			<h1 class="createtext"> FEEDBACK </h1> 
                        <center>
                        <%
                            try{
                                String fmeg = session.getAttribute("feedbackmeg").toString();
                                out.print(fmeg);
                                session.removeAttribute("feedbackmeg");
                            }catch(Exception e){}
                        %>
                        ...
                        <br><br>
                        <form  name="feedbackform" action="feedback-process.jsp" method="post">
			 <input type="hidden" name="feedback" value="Feedback">
                         
			<label for="l3"> <h3> Name </h3> </label>
			<input id="l3" type="text" name="name" placeholder="Name" /><br />
                        
			<label for="l4"><h3> Subject </h3></label>
			<input id="l4" type="text" name="subject" placeholder="Subject"/><br />
                        
			<label for="r5"> <h3> Message </h3> </label>
			<input id="r5" type="text" name="message" placeholder="Message" /><br /><br /><br />
			
                        <center>
                            <button id="logout" onclick="return feedbackvalidation();" value="feedback" > Send Message </button>
			</center>
